...
//bob.up() ; ยกปากกาขึ้น
       bob.penColor("midnightblue");
        ...
        //วาดกระทง
        bob.down();
        bob.penColor("limegreen");
        bob.forward(70);
        bob.left(90);
        bob.forward(10);
        bob.left(90);
        bob.penColor("seagreen");
        bob.forward(70);
        bob.right(90);
        ...
        for(int i=0;i<250;i++) {
            ...
            bob.left(5);
            if(i%10==0)
                bob.dot("red",i*0.2); //dot red circle
        }*/
    }
